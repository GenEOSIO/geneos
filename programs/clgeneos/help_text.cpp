...
You can check the contract's abi by using 'clgeneos get code' command.)=====";
...
If you are currently using 'clgeneos push action' command, try to add the relevant authority using -p option.)=====";
